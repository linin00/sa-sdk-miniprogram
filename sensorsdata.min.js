...
(logger.info = function () {
  ...
  (sa.setPara = function (e) {
    ...
    if (_.isArray(sa.para.source_channel))
      for (var a = sa.para.source_channel.length, r = 0; r < a; r++)
        -1 ===
          ...
          ) && t.push(sa.para.source_channel[r]);
    (sa.para.source_channel = t),
    ...
    var n = { share: !1, utm: !1 };
    !0 === sa.para.is_persistent_save
      ? ((sa.para.is_persistent_save = _.extend({}, n)),
        (sa.para.is_persistent_save.utm = !0))
      : _.isObject(sa.para.is_persistent_save) &&
        (sa.para.is_persistent_save = _.extend(
          {},
          n,
...
!(function () {
  ...
  var e = ArrayProto.forEach,
    ...
    s = (_.each = function (t, a, s) {
      if (null == t) return !1;
      if (e && t.forEach === e) t.forEach(a, s);
      else if (t.length === +t.length) {
        for (var n = 0, i = t.length; n < i; n++)
          if (n in t && a.call(s, t[n], n, t) === r) return !1;
      } else
        for (var o in t)
          if (hasOwnProperty.call(t, o) && a.call(s, t[o], o, t) === r)
            return !1;
    });
  (_.logger = logger),
    (_.extend = function (e) {
  ...
  (_.unique = function (e) {
    for (var t, a = [], r = {}, s = 0; s < e.length; s++)
      (t = e[s]) in r || ((r[t] = !0), a.push(t));
    return a;
  }),
  ...
  (_.utf8Encode = function (e) {
    ...
    for (
      ...
      i < 128
        ...
        null !== o &&
          (a > t && (n += e.substring(t, a)), (n += o), (t = a = s + 1));
    }
  ...
  (_.base64Encode = function (e) {
    ...
    do {
      (t =
        ...
        (r = (n >> 6) & 63),
        (s = 63 & n),
        (p[c++] = i.charAt(t) + i.charAt(a) + i.charAt(r) + i.charAt(s));
    } while (o < e.length);
  ...
  (_.rot13obfs = function (e, t) {
    ...
    for (var a = (e = String(e)).split(""), r = 0, s = a.length; r < s; r++) {
      a[r].charCodeAt(0) < 126 &&
        (a[r] = String.fromCharCode((a[r].charCodeAt(0) + t) % 126));
    }
    return a.join("");
  }),
  ...
  (_.getCurrentUrl = function (e) {
    ...
    return (
      _.isObject(e) &&
        e.sensors_mp_encode_url_query &&
        (a = e.sensors_mp_encode_url_query),
      t ? (a ? t + "?" + a : t) : "\u672a\u53d6\u5230"
    );
  }),
  ...
  (_.getCustomUtmFromQuery = function (e, t, a, r) {
    ...
    if (e.sa_utm)
      for (var n in e)
        "sa_utm" !== n
          ? _.include(sa.para.source_channel, n) && (s[a + n] = e[n])
          : (s[r + n] = e[n]);
    else
      for (var n in e)
  ...
  (_.objToParam = function (e, t) {
    ...
    for (var r in e)
      if (e.hasOwnProperty(r)) {
        ...
        void 0 === s
          ? a.push(r + "=")
          : ((s = t ? encodeURIComponent(s) : s), a.push(r + "=" + s));
      }
    return a.join("&");
  }),
  (_.delObjectKey = function (e) {
    if ("[object Object]" === Object.prototype.toString.call(e))
      for (let t = 0; t < share_info_key.length; t++)
        delete e[share_info_key[t]];
  ...
  (_.shareInfoData = function (e) {
    ...
    if (sa.para.preset_events.share_info_use_string) {
      ...
      if (((a = _.decodeURIComponent(e.query.sampshare)), !_.isJSONString(a)))
        return {};
  ...
  (_.setShareInfo = function (e, t) {
    ...
    "string" == typeof c
      ? ((t.$share_distinct_id = c),
        (share_distinct_id = c),
        (r.$latest_share_distinct_id = c))
      : (t.$share_distinct_id = "\u53d6\u503c\u5f02\u5e38"),
      "number" == typeof i
        ? !share_distinct_id ||
          (share_distinct_id !== s && share_distinct_id !== n)
          ? !share_distinct_id ||
            (share_distinct_id === s && share_distinct_id === n)
            ? (t.$share_depth = "-1")
            : ((t.$share_depth = i + 1),
              (query_share_depth = i + 1),
              (r.$latest_share_depth = i + 1))
          : ((t.$share_depth = i),
            (query_share_depth = i),
            (r.$latest_share_depth = i))
        : (t.$share_depth = "-1"),
      "string" == typeof o
        ? ((t.$share_url_path = o), (r.$latest_share_url_path = o))
        : (t.$share_url_path = "\u53d6\u503c\u5f02\u5e38"),
      "string" == typeof u
        ? ((t.$share_method = u), (r.$latest_share_method = u))
        : (t.$share_method = "\u53d6\u503c\u5f02\u5e38"),
      _.setLatestShare(r);
  }),
  ...
  (_.setSfSource = function (e, t) {
    !_.isEmptyObject(e.query) &&
      e.query._sfs &&
      ((t.$sf_source = e.query._sfs),
      sa.registerApp({ $latest_sf_source: t.$sf_source }));
  }),
  ...
  Object.defineProperty(wx, "setNavigationBarTitle", {
    get: function () {
      return function (e) {
        ...
        (e = _.isObject(e) ? e : {}),
          (globalTitle[a] = e.title),
          oldSetNavigationBarTitle.call(this, e);
      };
    },
  });
} catch (e) {
...
function clickTrack(e) {
  ...
  if (
    ...
    _.isObject(e.event_prop) && (r = e.event_prop),
    t && _.isClick(t))
  ) {
    if (
...
(_.setRefPage = function () {
  try {
    ...
    if (e && 1 === e.length) {
      var t = e[e.length - 1].route,
        a = { title: _.getPageTitle(t), route: t };
      page_route_map.length >= 2
        ? page_route_map[page_route_map.length - 1].route !== a.route &&
          (page_route_map.push(a), page_route_map.shift())
        : page_route_map.push(a);
    }
  } catch (e) {
    logger.info(e);
  }
  ...
  (_.getRefPage = function () {
    ...
    try {
      var t = getCurrentPages();
      if (t && t.length >= 2)
        (e.route = t[t.length - 2].route), (e.title = _.getPageTitle(e.route));
      else if (t && t.length >= 1) {
        if (page_route_map.length >= 2) {
          var a = page_route_map;
          (e.route = a[a.length - 2].route),
            (e.title = _.getPageTitle(e.route));
        }
        e.route === t[t.length - 1].route &&
          (e = { title: "", route: "\u76f4\u63a5\u6253\u5f00" });
      }
    } catch (e) {
      logger.info(e);
    ...
    try {
      if (__wxConfig) {
        ...
        if (
          ...
          s &&
            s.window &&
            s.window.navigationBarTitleText &&
            (i.titleVal = s.window.navigationBarTitleText),
          !i.titleVal && __wxAppCode__)
        ) {
          var o = __wxAppCode__[e + ".json"];
          o &&
            o.navigationBarTitleText &&
            (i.titleVal = o.navigationBarTitleText);
        }
        if (
          (_.each(globalTitle, function (a, r) {
            if (r === e) return (t = a);
          }),
          0 === t.length)
        ) {
  ...
  (_.wxrequest = function (e) {
    if (_.compareSDKVersion(wxSDKVersion, "2.10.0") >= 0)
      (e.timeout = sa.para.datasend_timeout), wx.request(e);
    else {
      var t = wx.request(e);
      setTimeout(function () {
  ...
  (_.getAppId = function () {
    var e;
    if (
      (wx.getAccountInfoSync && (e = wx.getAccountInfoSync()),
      _.isObject(e) && _.isObject(e.miniProgram))
    )
      return e.miniProgram.appId;
  }),
  (_.validId = function (e) {
    return ("string" != typeof e && "number" != typeof e) || "" === e
      ? (logger.info("\u8f93\u5165 ID \u7c7b\u578b\u9519\u8bef"), !1)
      : "number" != typeof e || ((e = String(e)), /^\d+$/.test(e))
      ? e
      : (logger.info("\u8f93\u5165 ID \u7c7b\u578b\u9519\u8bef"), !1);
  }),
            ...
            (e.brand = _.setUpperCase(t.brand)),
              ...
              (e.os =
                ...
                "ios" === (r = a.toLowerCase())
                  ...
                  : a)),
              (e.os_version =
                t.system.indexOf(" ") > -1 ? t.system.split(" ")[1] : t.system),
              (wxSDKVersion = t.SDKVersion);
          },
          complete: function () {
            var t = new Date().getTimezoneOffset(),
              a = _.getAppId();
            _.isNumber(t) && (e.timezone_offset = t),
              a && (e.app_id = a),
  ...
  (sa.prepareData = function (e, t) {
    if (
      current_scene &&
      1154 === current_scene &&
      !sa.para.preset_events.moments_page
    )
      return !1;
    var a = {
    ...
    if (
      ...
      (a._track_id = Number(
        ...
        (a.properties.is_first_day = _.getIsFirstDay());
      var r = _.getRefPage();
      a.properties.hasOwnProperty("referrer") ||
        (a.properties.referrer = r.route),
        a.properties.hasOwnProperty("referrer_title") ||
          (a.properties.referrer_title = r.title);
    }
  ...
  (sa.store = {
    ...
    getStorage: function () {
      return this.storageInfo
        ? this.storageInfo
        : ((this.storageInfo =
            sa._.getStorageSync(sa.para.storage_store_key) || ""),
          this.storageInfo);
    },
    _state: {},
    mem: {
    ...
    encryptStorage: function () {
      var e = this.getStorage(),
        t = "data:enc;";
      _.isObject(e)
        ? (e = t + _.rot13obfs(JSON.stringify(e)))
        : _.isString(e) && -1 === e.indexOf(t) && (e = t + _.rot13obfs(e)),
        sa._.setStorageSync(sa.para.storage_store_key, e);
    },
    save: function () {
      var e = JSON.parse(JSON.stringify(this._state));
      if (
        (delete e._first_id, delete e._distinct_id, sa.para.encrypt_storage)
      ) {
  ...
  (sa.incrementProfile = function (e, t) {
    ...
    var a = e;
    _.isString(e) && ((e = {})[a] = 1),
      sa.prepareData({ type: "profile_increment", properties: e }, t);
  }),
  ...
  (_.setLatestChannel = function (e) {
    _.isEmptyObject(e) ||
      ...
      sa.para.is_persistent_save.utm ? sa.register(e) : sa.registerApp(e));
  }),
  (_.setLatestShare = function (e) {
    (e.$latest_share_depth ||
      ...
      sa.para.is_persistent_save.share ? sa.register(e) : sa.registerApp(e));
  }),
  (sa.login = function (e) {
    if ((e = _.validId(e))) {
        ...
        wx.getLocation({
          ...
          success: function (e) {
            sa.registerApp({
              ...
              $geo_coordinate_system: _.setUpperCase(
                sa.para.preset_properties.location.type
              ),
            });
          },
          fail: function (e) {
  ...
  (sa.openid = {
    getRequest: function (e) {
      wx.login({
        success: function (t) {
          t.code && sa.para.appid && sa.para.openid_url
            ? _.wxrequest({
                url:
                  sa.para.openid_url +
                  "&code=" +
                ...
                method: "GET",
                complete: function (t) {
                  _.isObject(t) && _.isObject(t.data) && t.data.openid
                    ? e(t.data.openid)
                    : e();
                },
              })
  ...
  (sa.init = function (e) {
    ...
    (this.hasInit = !0),
      sa.setPara(e),
      sa.para.encrypt_storage && this.store.encryptStorage(),
      sa.para.batch_send &&
        (wx.getStorage({
  ...
  (sa.sendStrategy = {
      ...
      if (_.isArray(e.data) && e.data.length > 0) {
        ...
        e.data.forEach(function (e) {
          ...
          _.wxrequest({
            ...
            method: "POST",
            dataType: "text",
            //data: "data_list=" + encodeURIComponent(_.base64Encode(e.data)),//暂时不用加密
            data: e.data,
            success: function () {
              e.success(e.len);
            },
    ...
    batchWrite: function () {
      ...
      this.dataHasChange &&
        ...
        this.syncStorage &&
          sa._.setStorageSync(
            sa.para.storage_prepare_data_key,
            sa.store.mem.mdata
          ));
    },
  ...
  (sa.initWithOpenid = function (e, t) {
    (e = e || {}).appid && (sa.para.appid = e.appid),
      sa.openid.getOpenid(function (a) {
        a && sa.setOpenid(a, e.isCoverLogin),
          t && _.isFunction(t) && t(a),
          sa.init(e);
      });
  }),
  (sa.setWebViewUrl = function (e, t) {
    ...
    _.urlSafeBase64 && _.urlSafeBase64.encode
      ? (c = c
          ? _.urlSafeBase64.trim(_.urlSafeBase64.encode(_.urlBase64Encode(c)))
          : "")
      : this._.rot13obfs && (c = c ? _.rot13obfs(c) : ""),
    ...
    t
      ? ((a = i.indexOf("_sasdk")),
        (o =
          i.indexOf("?") > -1
            ? a > -1
              ? s + n + "#" + i.substring(1, a) + "_sasdk=" + p
              : s + n + "#" + i.substring(1) + "&_sasdk=" + p
            : s + n + "#" + i.substring(1) + "?_sasdk=" + p))
      : ((a = n.indexOf("_sasdk")),
        (o = /^\?(\w)+/.test(n)
          ? a > -1
            ? s + "?" + n.substring(1, a) + "_sasdk=" + p + i
            : s + "?" + n.substring(1) + "&_sasdk=" + p + i
          : s + "?" + n.substring(1) + "_sasdk=" + p + i));
    return o;
  }),
  _.each(
    ...
    function (e) {
      ...
      sa[e] = function () {
        sa.initialState.isComplete
          ...
          : sa.initialState.queue.push([e, arguments]);
      };
    }
  ),
  ...
  (sa.autoTrackCustom = {
    trackCustom: function (e, t, a) {
      ...
      sa.para.autoTrack &&
        r &&
        ("function" == typeof r
          ? ((s = r()), _.isObject(s) && _.extend(t, s))
          : _.isObject(r) && (_.extend(t, r), (sa.para.autoTrack[e] = !0)),
        sa.track(a, t));
    },
    appLaunch: function (e, t) {
      ...
      var a = {};
      e && e.scene
        ? ((current_scene = e.scene), (a.scene = _.getMPScene(e.scene)))
        : (a.scene = "\u672a\u53d6\u5230\u503c"),
        e &&
          e.scene &&
          1010 === e.scene &&
          e.query &&
          (e.query.sampshare && delete e.query.sampshare,
          _.delObjectKey(e.query)),
        e &&
          e.path &&
          ((a.url_path = _.getPath(e.path)),
          !0 === sa.para.preset_properties.url_path &&
            sa.registerApp({ url_path: a.url_path })),
        _.setShareInfo(e, a);
      var r = _.setUtm(e, a);
      is_first_launch
        ? ((a.is_first_time = !0),
        ...
        : (a.is_first_time = !1),
        _.setLatestChannel(r.pre2),
        _.setSfSource(e, a),
        sa.registerApp({ latest_scene: a.scene }),
        (a.url_query = _.setQuery(e.query)),
        _.setPageRefData(a),
        t
          ? ((a = _.extend(a, t)), sa.track("$MPLaunch", a))
          : sa.para.autoTrack &&
    ...
    appShow: function (e, t) {
      ...
      (mpshow_time = new Date().getTime()),
        ...
        e &&
          ...
          !0 === sa.para.preset_properties.url_path &&
            sa.registerApp({ url_path: a.url_path })),
        !_.isObject(sa.para.preset_properties.location) ||
          ("wgs84" !== sa.para.preset_properties.location.type &&
            "gcj02" !== sa.para.preset_properties.location.type) ||
          sa.getLocation(),
        _.setShareInfo(e, a);
      var r = _.setUtm(e, a);
      _.setLatestChannel(r.pre2),
        ...
        (a.url_query = _.setQuery(e.query)),
        t
          ? ((a = _.extend(a, t)), sa.track("$MPShow", a))
          : sa.para.autoTrack &&
    ...
    appHide: function (e) {
      ...
      (a.url_path = _.getCurrentPath()),
        mpshow_time &&
          t - mpshow_time > 0 &&
          (t - mpshow_time) / 36e5 < 24 &&
          (a.event_duration = (t - mpshow_time) / 1e3),
        _.setPageRefData(a),
        e
          ? ((a = _.extend(a, e)), sa.track("$MPHide", a))
          : sa.para.autoTrack &&
    ...
    pageLoad: function (e) {
      current_scene &&
        1010 === current_scene &&
        e &&
        (e.sampshare && delete e.sampshare, _.delObjectKey(e)),
        e &&
          _.isObject(e) &&
          ((this.sensors_mp_url_query = _.setQuery(e)),
          (this.sensors_mp_encode_url_query = _.setQuery(e, !0)));
    },
    pageShow: function () {
      var e = {},
        t = _.getCurrentPath(),
    ...
    pageShare: function (e) {
      ...
      e.onShareAppMessage = function () {
        ...
        if (sa.para.autoTrack && sa.para.autoTrack.pageShare) {
          ...
          _.setPageRefData(a),
            sa.autoTrackCustom.trackCustom("pageShare", a, "$MPShare");
        }
        return (
          sa.para.allow_amend_share_path &&
            ("object" != typeof e && ((e = {}).path = _.getCurrentUrl(this)),
            "object" != typeof e ||
              (void 0 !== e.path && "" !== e.path) ||
              (e.path = _.getCurrentUrl(this)),
            "object" == typeof e &&
              "string" == typeof e.path &&
              (-1 === e.path.indexOf("?")
                ? (e.path = e.path + "?")
                : "&" !== e.path.slice(-1) && (e.path = e.path + "&")),
            (e.path = e.path + _.getShareInfo())),
          e
        );
      };
    },
    pageShareTimeline: function (e) {
      ...
      e.onShareTimeline = function () {
        ...
        return (
          sa.para.allow_amend_share_path &&
            ("object" != typeof e && (e = {}),
            "object" == typeof e && void 0 === e.query && (e.query = ""),
            "object" == typeof e &&
              "string" == typeof e.query &&
              "" !== e.query &&
              "&" !== e.query.slice(-1) &&
              (e.query = e.query + "&"),
            (e.query = e.query + _.getShareInfo())),
          e
        );
      };
    },
  ...
  (sa.quick = function () {
    ...
    if ("getAnonymousID" === e) {
      ...
      "appLaunch" === e || "appShow" === e
        ? t
          ? sa.autoTrackCustom[e](t, r)
          : logger.info(
              "App\u7684launch\u548cshow\uff0c\u5728sensors.quick\u7b2c\u4e8c\u4e2a\u53c2\u6570\u5fc5\u987b\u4f20\u5165App\u7684options\u53c2\u6570"
            )
        : "appHide" === e &&
          ((r = _.isObject(t) ? t : {}), sa.autoTrackCustom[e](r));
  }),
  ...
  (sa.pageShow = function (e) {
    ...
    !0 === sa.para.preset_properties.url_path &&
      sa.registerApp({ url_path: a }),
      r && (t.title = r),
      (t.url_path = a),
      (t.url_query = s.sensors_mp_url_query ? s.sensors_mp_url_query : ""),
...
Page = function (e) {
  ...
  sa.para.autoTrack && sa.para.autoTrack.mpClick && tabProxy(e),
    ...
    "function" == typeof e.onShareTimeline &&
      sa.autoTrackCustom.pageShareTimeline(e),
...
(Component = function (e) {
  try {
    ...
    if (t)
      for (var a = 0, r = t.length; a < r; a++) click_proxy(e.methods, t[a]);
    sa.para.autoTrack && sa.para.autoTrack.mpClick && tabProxy(e.methods),
      mp_proxy(e.methods, "onLoad", "pageLoad"),
      mp_proxy(e.methods, "onShow", "pageShow"),
      mp_proxy(e.methods, "onAddToFavorites", "pageAddFavorites"),
      "function" == typeof e.methods.onShareAppMessage &&
        sa.autoTrackCustom.pageShare(e.methods),
      "function" == typeof e.methods.onShareTimeline &&
        sa.autoTrackCustom.pageShareTimeline(e.methods),
